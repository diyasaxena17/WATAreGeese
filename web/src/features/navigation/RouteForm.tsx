...
export default function RouteForm({
	...
	return (
		<form className="relative space-y-4" onSubmit={onSubmit}>
			<div className="wg-routing-form-pattern space-y-4 p-3">
			...
			{activeEndpoint ? (
				<div className="wg-routing-form-pattern fixed inset-x-0 bottom-0 z-[1200] h-[82svh] rounded-t-sheet border border-border p-4 shadow-sheet md:absolute md:inset-x-0 md:top-0 md:h-[min(36rem,calc(100vh-8rem))] md:rounded-panel md:shadow-panel">
